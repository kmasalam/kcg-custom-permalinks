...
class Custom_Permalinks_About {
	...
	/**
	 * Print HTML for KCG Custom Permalinks About Page.
	 *
	 * @since 1.2.11
	 * @access private
	 *
	...
	private function more_plugins() {
		$img_src = plugins_url( '/assets/images', KCG_CUSTOM_PERMALINKS_FILE )
		?>
			...
			<div class="float">
				...
				<div class="tagline">
					<p>
						<?php
						esc_html_e(
							'Thank you for choosing KCG Custom Permalinks! I hope that your experience with our plugin for updating permalinks is quick and easy. I am trying to make it more feasible for you and provide capabilities in it.',
							'custom-permalinks'
						);
						?>
					</p>
					<p>
						...
						?>
						<a href="https://wordpress.org/support/plugin/custom-permalinks/reviews/?rate=5#new-post" title="KCG Custom Permalinks Rating" target="_blank">
						<?php
				...
				<div class="float">
					...
					<img src="<?php echo $img_src . '/custom-permalinks.svg'; ?>" alt="<?php esc_html_e( 'KCG Custom Permalinks', 'custom-permalinks' ); ?>" title="<?php esc_html_e( 'KCG Custom Permalinks', 'custom-permalinks' ); ?>" />
				</div>
